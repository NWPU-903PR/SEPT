...
def combine_npy(filepath,test_split=0.5):
    ...
    X_e = np.load(filepath + "/enhancer_of_HeLa-S3.npy")
    X_e_test = np.load(filepath + "/enhancer_of_K562.npy")
    
    X_p = np.load(filepath + "/promoter_of_HeLa-S3.npy")
    X_p_test = np.load(filepath + "/promoter_of_K562.npy") 
    
    y = np.load(filepath + "/label_of_HeLa-S3.npy")
    y_test = np.load(filepath + "/label_of_K562.npy") 
